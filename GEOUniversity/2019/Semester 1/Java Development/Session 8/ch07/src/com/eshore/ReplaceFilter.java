...
public class ReplaceFilter implements Filter{
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		try {
			//导入资源文件,getClass()方法是获得对象当前的类类型，ClassLoader的具体作用就是将class文件加载到jvm虚拟机中去
			//ReplaceFilter.class可替换为this.getClass()
			propert.load(this.getClass().getClassLoader().getResourceAsStream(filePath));
