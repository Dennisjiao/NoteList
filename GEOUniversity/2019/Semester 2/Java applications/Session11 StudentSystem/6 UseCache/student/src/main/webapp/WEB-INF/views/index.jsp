				...
				<div class="layui-side-scroll">
					...
					<ul class="layui-nav layui-nav-tree" lay-shrink="all"
						...
						<li data-name="user" class="layui-nav-item layui-nav-itemed">
							<a lay-href="user" lay-tips="用户管理" lay-direction="2">
							    <i class="layui-icon layui-icon-username"></i><cite>用户管理</cite>
						    </a>							
						</li>
						<li data-name="course" class="layui-nav-item layui-nav-itemed">
							<a lay-href="course" lay-tips="课程管理" lay-direction="2"><i
								class="layui-icon layui-icon-read"></i><cite>课程管理</cite>
						</a>							
						</li>
						<li data-name="coursechoosing" class="layui-nav-item layui-nav-itemed">
							<a lay-href="coursechoosing" lay-tips="选课管理" lay-direction="2"><i
								class="layui-icon layui-icon-star"></i><cite>选课管理</cite>
						</a>							
						</li>
						<li data-name="score" class="layui-nav-item layui-nav-itemed">
							<a lay-href="score" lay-tips="成绩管理" lay-direction="2"><i
