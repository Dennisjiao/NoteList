...
public class TrackCounter {
    ...
    //定义切点
    @Pointcut("execution(* bean.CompactDisc.playTrack(int)) && args(trackNumber)")
  ...
  //定义切点
    @Pointcut("execution(* bean.CompactDisc.play(..))")
    public void play(){}
    ...
    //定义切点
    @Pointcut("execution(* bean.CompactDisc.throwExceptionTest(..))")
